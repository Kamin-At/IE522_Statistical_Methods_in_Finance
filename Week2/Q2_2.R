...
# Answer to Q2.2 => Yes, a laplace distribution fit our the daily-return data much better than using a normal distribution. It captures the peak and tails of the true distribution relatively well.